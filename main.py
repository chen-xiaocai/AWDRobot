...
def main():
	task_list = [
		...
		# [1, TASK_ID_3, TASK_DIR_BACK, '3_1'],
		# [2, TASK_ID_3, TASK_DIR_BACK, '3_2'],
		[3, TASK_ID_3, TASK_DIR_BACK, '3_3'],
		# [4, TASK_ID_3, TASK_DIR_BACK, '3_4'],
		# [5, TASK_ID_3, TASK_DIR_BACK, '3_5'],
		# [6, TASK_ID_3, TASK_DIR_BACK, '3_6'],
		# [7, TASK_ID_3, TASK_DIR_BACK, '3_7'],
		# [8, TASK_ID_3, TASK_DIR_BACK, '3_8'],
		# [9, TASK_ID_3, TASK_DIR_BACK, '3_9'],
		# [10, TASK_ID_3, TASK_DIR_BACK, '3_10'],
